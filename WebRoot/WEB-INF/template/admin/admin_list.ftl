...
<body class="list">
	...
	<div class="body">
		<form id="listForm" action="admin!list.action" method="post">
			<div class="listBar">
				<input type="button" class="formButton" onclick="location.href='admin!add.action'" value="添加用户" hidefocus />
				&nbsp;&nbsp;
			...
			<table id="listTable" class="listTable">
				...
				<#list pager.result as admin>
					<tr>
						...
						<td>
							<#assign roleSetStr = '' />
							<#list admin.roleSet as role>
								<#assign roleSetStr = roleSetStr + role.name + ' ' />
							</#list>
							<span title="${roleSetStr}">
								${substring(roleSetStr, 30, "...")}
							</span>
						</td>
						<td>

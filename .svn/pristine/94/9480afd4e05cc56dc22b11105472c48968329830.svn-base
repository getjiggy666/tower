...
if(typeof(KindEditor) != "undefined") {
	KindEditor.ready(function(K) {
		editor = K.create("#editor", {
			...
			uploadJson: bizflow.base + "/admin/file!ajaxUpload.action",
			fileManagerJson: bizflow.base + "/admin/file!ajaxBrowser.action",
...
function currencyFormat(price) {
	price = setScale(price, bizflow.priceScale, bizflow.priceRoundType);
	return bizflow.currencySign + price + bizflow.currencyUnit;
}

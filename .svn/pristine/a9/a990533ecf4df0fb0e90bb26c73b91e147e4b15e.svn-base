		...
		<form id="validateForm" action="<#if isAddAction>article_category!save.action<#else>article_category!update.action</#if>" method="post">
			...
			<table class="inputTable">
				...
				<tr>
					...
					<td>
						<input type="text" id="articleCategoryMetaDescription" name="articleCategory.metaDescription" class="formText" value="${(articleCategory.metaDescription)!}" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type="text" id="articleCategoryMetaKeywords" name="articleCategory.metaKeywords" class="formText" value="${(articleCategory.metaKeywords)!}" />
					</td>
				</tr>
				<tr>
					<th>

...
import com.telecom.util.CookieUtils;
...
public class BaseAppAction extends ActionSupport {
	...
	private static final long serialVersionUID = 6718838483334455667L;
	...
	protected String token;		//	token验证码
	...
	public String output(String obj) {
		...
		getResponse().setHeader("Access-Control-Allow-Headers", "x-requested-with");

...
<body class="list message">
	...
	<div class="body">
		<form id="listForm" action="message!outbox.action" method="post">
			<div class="listBar">
				<input type="button" class="formButton" onclick="location.href='message!send.action'" value="发送通知" hidefocus />
				<label>查找: </label>
				<select name="pager.searchBy">
					<option value="toAdmin.username"<#if pager.searchBy == "toAdmin.username"> selected</#if>>
						收件人
					</option>
			...
			<table id="listTable" class="listTable">
				<tr>
					...
					<th>
						<a href="#" class="sort" name="toAdmin" hidefocus>收件人</a>
					</th>
					<th>
